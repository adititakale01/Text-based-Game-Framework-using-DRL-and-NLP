...
#####################################################################
        ...
        if (brain.timeStep % config.EVAL == 0) and (brain.timeStep != 0):
            ...
            evalQValues_a = brain.action_valueT.eval(feed_dict={brain.stateInputT:brain.convert(checkStates)},session = brain.session)
            ...
            evalQValues_o = brain.object_valueT.eval(feed_dict={brain.stateInputT:brain.convert(checkStates)},session = brain.session)
